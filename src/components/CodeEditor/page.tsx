        ...
        <div style={editorContainerStyle}>
          <div style={buttonGroupStyle}>
            <button onClick={handleRunCode} style={runButtonStyle}>
              Run
              <PlayCircleOutlined style={{ marginLeft: "5px" }} />
            </button>
          ...
          <h2 style={subHeaderStyle}>Code</h2>
          <MonacoEditor
            height="200px"
            width="100%"
          ...
          />
          <h2 style={subHeaderStyle}>Input</h2>
          <textarea
...
const mainContentStyle = {
  display: "flex",
  gap: "20px",
  flexWrap: "wrap" as const, // Ensures wrapping on smaller screens
...
const buttonGroupStyle = {
  display: "flex",
  gap: "15px",
  flexWrap: "wrap" as const, // Buttons stack on small screens
};
